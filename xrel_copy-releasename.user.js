...
// @icon		http://i.imgur.com/nSCWA81s.png
// @grant       none
// ==/UserScript==
...
// ---------- Script --------------------------------------------------------------------------------------------------
//
var defbgimg	= 'http://i.imgur.com/hbKJ9lR.png';
var ownlogo		= 'http://i.imgur.com/LvdmVzr.png';
var entries 	= getCookie('sl_list_entries');
var state		= getCookie('sl_list_state');
var sitealign	= getCookie('sl_sitealign');
...
if (sitealign == 1) { var siteright = '#rap {margin: 0 0 0 auto;}' } else { var siteright = '#rap {margin: 0 auto;}' }
...
$(function()
{
	...
	$('body').prepend('<div id="show_info">'
		...
		+'<ul>'
			...
			+'<li><input class="sl_check" id="check_sitealign" type="checkbox"> Seite rechtsbündig ausrichten</li>'
	...
	$('#check_sitealign').click(function()
	{
		if ($(this).is(':checked') == true)
		{
			setCookie('sl_sitealign','1',900);
			$('#rap').css('margin','0 0 0 auto');
		}
		else
		{
			setCookie('sl_sitealign','0',900);
			$('#rap').css('margin','0 auto');
		}
	});
	...
	$(
		"h2:contains('Bookmark:'),"
		+"h2:contains('Feeds:'),"
		+"h2:contains('Mirror Howto:'),"
		+"h2:contains('Partner')"
	).css("display","none");
});
//
